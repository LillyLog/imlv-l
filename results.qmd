...
2. **XGBoost achieved the highest predictive accuracy** with an R² of approximately 0.83, indicating it can explain about 83% of the variance in traffic volume.
